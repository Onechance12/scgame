...
function buildExterior() {
  ...
  if (oakSrc) {
    [[-24, -14, 0.3, 6.2], [22, -22, 1.8, 7.0], [-19, -36, 3.6, 5.4], [27, -40, 5.1, 6.6], [-30, -46, 2.4, 7.4],
     ...
     [-12, -56, 4.6, 6.6], [12, -62, 0.9, 7.0], [-52, -14, 5.3, 6.3],
     // and crowding the road itself — old and young trunks staggered close
     // enough that the walk up is THROUGH the trees, not past them
     [-5.2, -9, 0.8, 4.2], [5.5, -11, 2.6, 7.6], [-6.4, -16, 4.1, 9.0], [6.2, -20, 1.3, 5.0],
     [-5.8, -26, 3.0, 8.2], [5.4, -31, 5.2, 4.4], [-6.6, -37, 0.4, 7.0], [6.8, -35, 2.2, 8.8],
     [-5.5, -43, 1.7, 5.8], [6.0, -45, 3.9, 9.4], [-7.2, -50, 5.0, 6.4], [5.8, -53, 0.9, 7.8]].forEach(([ox, oz, yaw, sc]) => {
